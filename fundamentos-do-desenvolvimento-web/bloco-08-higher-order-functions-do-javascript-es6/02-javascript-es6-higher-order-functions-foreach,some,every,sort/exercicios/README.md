...
3. Encontre o primeiro livro cujo nomes possui 26 caracteres.
...
5. Faça uma função que retorne _true_, se todas as pessoas autoras nasceram no século XX, ou _false_, caso contrário.
...
6. Faça uma função que retorne _true_, se algum livro foi lançado na década de 80, e _false_, caso contrário.
...
7. Faça uma função que retorne _true_, caso nenhum author tenha nascido no mesmo ano, e _false_, caso contrário.
